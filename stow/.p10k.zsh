# Generated by Powerlevel10k configuration wizard on 2023-02-16 at 10:03 GMT.
...
() {
  ...
  # Icon color.
  # typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=$orange
  # typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=$orange
  # Custom icon.
